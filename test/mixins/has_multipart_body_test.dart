...
class _MultipartReq extends Request with HasMultipartBody {
  ...
  @override
  Future<FormData> multipartBody() async => FormData.fromMap({'f': 'v'});
}
...
void main() {
  group('HasMultipartBody', () {
    ...
    test(
        'buildOptions sets multipart/form-data contentType',
        () => expect(_MultipartReq().buildOptions()!.contentType,
